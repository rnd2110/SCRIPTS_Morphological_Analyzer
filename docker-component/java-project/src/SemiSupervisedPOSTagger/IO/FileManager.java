...
public class FileManager {
    ...
    public static IndexMaps createIndexMaps(String filePath, String delim,String clusterFile,String tagDictionaryPath, int brownSize) throws Exception{
        ...
        HashMap<String,Integer> additionalFeatureMap=new HashMap<String, Integer>();
        ...
        for (POS pos : POS.values()) {
        		additionalFeatureMap.put(pos.getValue(), pos.getIndex());
        	}
        ...
        return  new IndexMaps(tagSize,stringMap,additionalFeatureMap,reversedMap,clusterNMap,clusterMap,tagDictionary);
    }
}
