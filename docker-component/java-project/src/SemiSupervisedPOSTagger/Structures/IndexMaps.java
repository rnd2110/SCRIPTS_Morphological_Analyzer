...
public class IndexMaps  implements Serializable {
    ...
    public HashMap<String,Integer> additionalFeatureMap;
    ...
    public IndexMaps(int tagSize, HashMap<String, Integer> stringMap, HashMap<String, Integer> additionalFeatureMap, String[] reversedMap,
        ...
        this.additionalFeatureMap = additionalFeatureMap;
