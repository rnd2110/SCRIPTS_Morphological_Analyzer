...
public class BeamTagger {
    ...
    public static Pair<ArrayList<TaggingState>, TreeSet<BeamElement>> thirdOrderWithBeam(final Sentence sentence, final AveragedPerceptron perceptron, final boolean isDecode, int beamWidth,final boolean usePartialInfo,final Tagger tagger){
		int len = sentence.words.length + 1;
	    ...
	    return new Pair<ArrayList<TaggingState>, TreeSet<BeamElement>>(beam ,elements);
    ...
    public static Pair<int[],Float> thirdOrderWithScore(final Sentence sentence, final AveragedPerceptron perceptron, final boolean isDecode, int beamWidth,final boolean usePartialInfo,final Tagger tagger){
    		Pair<ArrayList<TaggingState>, TreeSet<BeamElement>> pairResult = thirdOrderWithBeam(sentence, perceptron, isDecode, beamWidth, usePartialInfo, tagger);
